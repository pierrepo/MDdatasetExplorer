...
def get_args() -> Tuple[str, str, str, str]:
    ...
    parser.add_argument("--engine_info", type=str, required=True, help="Path to the YML file containing information about the simulation engines for each file type.")
    ...
    return args.dataset_infos, args.file_infos, args.gro_infos, args.mdp_infos, args.engine_info
...
def generate_datasets(dataset_path: str, files_path: str, gro_path: str, mdp_path: str, engine_infos: str) -> None:
    ...
    file_type_to_engine = {entry['type']: entry['engine'] for entry in engine_data['file_types']}
    ...
    for i, row in enumerate(df.itertuples()):
        ...
        extended_data[i]["software_engines"] = software_engines if software_engines else ["unknown"]
